...
class UsersSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create(['name'=>'Mariana M.','email'=>'mariana@joseito.com','password'=>Hash::make('123456789')]);
        Promotor::create(['nombrepromotor'=>'Mariana M.','correo'=>'mariana@joseito.com']);

        User::create(['name'=>'Richard','email'=>'richard@joseito.com','password'=>Hash::make('123456789')]);
        Promotor::create(['nombrepromotor'=>'Richard','correo'=>'richard@joseito.com']);

        User::create(['name'=>'Wilmar','email'=>'wilmar@joseito.com','password'=>Hash::make('123456789')]);
        Promotor::create(['nombrepromotor'=>'Wilmar','correo'=>'wilmar@joseito.com']);
...
//        User::create(['name'=>'Admin','email'=>'admin@joseito.com','password'=>Hash::make('admin123')]);
